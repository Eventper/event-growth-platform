...
export default function WorkingDecorDemo() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#330311] to-[#2a0209] p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="grid w-full grid-cols-6 bg-black/40 backdrop-blur-md border border-white/20 p-1 gap-1 h-auto">
            <TabsTrigger 
              value="colors" 
